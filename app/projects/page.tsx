...
import AK3 from "@/public/AK1.png";
...
export default function Projects() {
    ...
    return (
        <div className={darkMode ? "dark bg-backgroundColor" : "bg-lightBackground"}>
            <div className="flex justify-center">
                <div className="max-w-7xl">
                    <nav className="py-6 px-5 bg-lightBackground dark:bg-backgroundColor">
                        <div className="p-5 rounded-2xl flex items-center justify-between bg-lightContrast dark:bg-contrastBackground transition ease-in-out duration-200 hover:shadow-lg hover:shadow-gray-300 dark:hover:shadow-zinc-800">
                            ...
                            <ul className="flex items-center gap-1 lg:mr-3">
                                <li>
                                    <BsFillMoonStarsFill
                    ...
                    <main className="px-5 min-h-screen bg-lightBackground dark:bg-backgroundColor flex flex-col items-center gap-5">
